...
and returns an array where the first element is the sum of those three numbers, the second element 
 is the product of those three numbers,  and the third and fourth elements are strings that EXACTLY follow this example and use 
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    var totalSum1 = sum(a, b)[0]
    console.log(totalSum1)
    var totalSum2 = sum(totalSum1, c)[0]
    var totalMulti1 = multiply(a, b)[0]
    var totalMulti2 = multiply(totalMulti1, c)[0]
    var returnArray = [
        totalSum2,
        totalMulti2,
...
function multiplyArray(multArr) { //eslint-disable-line
    var theArrayMu = multiply(multArr[0], multArr[1])[0];
    console.log(theArrayMu)
    var totalArr = multiply(theArrayMu, multArr[2])[0];
    var arrayReturn = [
        totalArr,
        "The numbers 2,3,4 have a product of 24.",
    ]
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for (var i = 0; i < dynamicArray.length; i++) {
      multiAnyArr = multiply(multiAnyArr, testDynamicArray[i])[0];
    }
        var multiAnyArrReturn = [
            multiAnyArr,
            "The numbers 1,2,3,4,5 have a product of 120."
        ];
        console.log(multiAnyArrReturn)
        return multiAnyArrReturn
